...
便携版也可以直接解压 `outputs\Xmouse-0.12.0-windows-x64.zip` 后运行 `Xmouse.exe`。请保留 `sqlite3.dll` 与程序在同一目录。
...
- 当前版本说明：`docs\RELEASE-NOTES-0.12.0.md`
- 完整版本历史：`CHANGELOG.md`
...
Release 可执行文件位于 `target\release\xmouse.exe`。当前版本说明见 `docs\RELEASE-NOTES-0.12.0.md`，完整变更历史见 `CHANGELOG.md`。
